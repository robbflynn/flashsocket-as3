package flashsocket.client.controllers.connection
{
	...
	import flashsocket.client.controllers.connection.events.ClientConnectionEvent;
	...
	public class ClientConnection extends ClientSocketUnit
	{
		...
		public var dispatchMessage:Boolean = false;
		...
		public function ClientConnection()
		{
			...
			_client.messageFn = processMessage;
			_client.dispatchMessage = false;
		...
		private function processMessage(message:FlashSocketMessage):void 
		{
			...
			if (dispatchMessage)
				dispatchEvent(new FlashSocketClientEvent(FlashSocketClientEvent.MESSAGE, message));
		}
