package flashsocket.client
{
	...
	[Event(name="connected", type="flashsocket.client.events.FlashSocketClientEvent")]
	[Event(name="disconnected", type="flashsocket.client.events.FlashSocketClientEvent")]
	[Event(name="message", type="flashsocket.client.events.FlashSocketClientEvent")]
	[Event(name="error", type="flashsocket.client.events.FlashSocketClientEvent")]
